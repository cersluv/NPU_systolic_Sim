	component sdram is
		port (
			...
			jtag_uart_0_chipselect  : in    std_logic                     := 'X';             -- chipselect
			jtag_uart_0_address     : in    std_logic                     := 'X';             -- address
			jtag_uart_0_read_n      : in    std_logic                     := 'X';             -- read_n
			jtag_uart_0_readdata    : out   std_logic_vector(31 downto 0);                    -- readdata
			jtag_uart_0_write_n     : in    std_logic                     := 'X';             -- write_n
			jtag_uart_0_writedata   : in    std_logic_vector(31 downto 0) := (others => 'X'); -- writedata
			jtag_uart_0_waitrequest : out   std_logic                                         -- waitrequest
		);
	end component sdram;
	...
	u0 : component sdram
		port map (
			...
			jtag_uart_0_chipselect  => CONNECTED_TO_jtag_uart_0_chipselect,  -- jtag_uart_0.chipselect
			jtag_uart_0_address     => CONNECTED_TO_jtag_uart_0_address,     --            .address
			jtag_uart_0_read_n      => CONNECTED_TO_jtag_uart_0_read_n,      --            .read_n
			jtag_uart_0_readdata    => CONNECTED_TO_jtag_uart_0_readdata,    --            .readdata
			jtag_uart_0_write_n     => CONNECTED_TO_jtag_uart_0_write_n,     --            .write_n
			jtag_uart_0_writedata   => CONNECTED_TO_jtag_uart_0_writedata,   --            .writedata
			jtag_uart_0_waitrequest => CONNECTED_TO_jtag_uart_0_waitrequest  --            .waitrequest
		);
